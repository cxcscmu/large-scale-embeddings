...
class FineWebSearcher:
    ...
    def __init__(self, verbose=False):
        ...
        self.fw_docs = FineWebDocs(
            ...
            max_cached_envs=20     # Keep 10 most recently used environments open
        )
    ...
    def search(self,
        ...
        # Step 3: Translate internal IDs to actual FineWeb document IDs
...
def test_time_performance(top_k=100, num_queries=100, parallel=True):
    ...
    """
    searcher = FineWebSearcher(verbose=False)
